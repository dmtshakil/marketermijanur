...
$(document).ready(function() {
    ...
    var typed = new Typed('#element', {
      strings: ['Search Engine Optimization',' Web Analytics Specialist ', 'Social Media Marketing', 'Conversion Rate Optimization', 'Search Engine Marketing'],
      typeSpeed: 50,
      backSpeed: 25,
      loop: true,
...
$(document).ready(function() {
    ...
    function adjustImageSize() {
      ...
      if (windowWidth < 768) {
        $('.image-content img').css('width', '340px');
      } else {
        $('.image-content img').css('width', '420px');
      }
    }
